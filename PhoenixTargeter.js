//Example Usage
//ALL CREDIT TO SPADAR FOR THIS, IVE ONLY MODIFIED A VERSION OF HIS
// https://github.com/Spadar/AdventureLand   SPADARS GITHUB
...
var targeter = new Targeter({
  ...
  ["Foaly", "WolfQueen", "MerkChant", "Wired", "BuffNStuff"], // whitelist
                ...
                if (character.ctype === "ranger") {
                    ...
                    var mobsTargetingParty = Object.values(parent.entities).filter(
                        shoot => shoot.type == "monster" && (
                            shoot.target === "YourMOM" || shoot.target === "Curse" || shoot.target === "Shield"
                        )
                    );
                    var arrayMTP = [];
